                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form  method="POST" action="{{route('update.contact')}}">
                                     @csrf
                                      <input type="text" name="id" value="{{$contacts->id}}">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
                                       <tr>
                                          <td height="50">Address</td>
                                          <td><input type="text" name="address" value="{{$contacts->address}}">
                                              @error('address')
                                          ...
                                          <td><input type="text" name="phone" value="{{$contacts->phone}}">
                                              @error('phone')
                                                  <label class="text-danger">
                                                    {{$message}}
                                                  </label>
                                          ...
                                          <td><input type="text" name="email" value="{{$contacts->email}}">
                                              @error('email')
                                                  <label class="text-danger">
                                                    {{$message}}
                                                  </label>
