                                       ...
                                       <tr>
                                          ...
                                          <tr>
                                            ...
                                            <td><input type="file" name="image">
                                              <img src="{{asset('uploads/'. $product->image)}}" style="width:100px; height:100px">
                                                @error('image')
                                        <label class="text-danger">
                                            {{$message}}
                                        </label>
                                        @enderror</td>
                                          ...
                                          <tr>
                                          <td height="50">cname</td>
                                          <td><select name="cname" selected>
                                             @foreach($category as $categorys)
                                            <option value="{{ $categorys->id }}" {{$categorys->id == $product->id ? 'selected' : ''}}>{{ $categorys->cname }}</option>
                                            @endforeach
                                            </select>
                                            </td>
